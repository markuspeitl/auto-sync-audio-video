...
def get_platform_store_value(key: str, platform_values_store: dict[str, dict[str, AnyValue]]) -> AnyValue:
...
def get_platform_value(platform_value_options: dict[str, AnyValue]) -> AnyValue:
